...
public:
    ...
    void ProcessPhysics(const double &time);
    ...
    static void handle_collision(CircleCollider *colliderA, CircleCollider *colliderB, const double &time);

    static void handle_collision(PolyCollider *colliderA, CircleCollider *colliderB, const double &time);

    static void handle_collision(PolyCollider *colliderA, PolyCollider *colliderB, const double &time);
};
